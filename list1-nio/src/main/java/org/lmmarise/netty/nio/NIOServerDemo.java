package org.lmmarise.netty.nio;
 ...
 * @since 2021/9/29 5:04 下午
 */
public class NIOServerDemo {
    private int port = 8080;

    private Selector selector;  // 轮询器 Selector 大堂经理
    private final ByteBuffer buffer = ByteBuffer.allocate(1024);    // 缓冲区 Buffer 等候区
